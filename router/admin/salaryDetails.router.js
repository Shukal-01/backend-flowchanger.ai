...
salaryController.delete('/salary/:id', salaryDetailsController.deleteSalaryRecord)
salaryController.get('/salary/:id', salaryDetailsController.getSalaryDetailsById)
