...
// const { clientSchema } = require("../../../utils/validations.js");
...
const addNewClient = async (req, res) => {
    try {
        const {
            ...
            default_language, address, country, state, city, zip_code
        } = req.body;
...
const fetchAllClients = async (req, res) => {
    try {
        ...
        return res.status(500).json({ status: 500, message: "An error occurred while fetching all clients." });
    }
};
...
const updateSpecificClient = async (req, res) => {
    ...
    try {
        ...
        return res.status(400).json({ status: true, message: "Customer not found!" });
    }
}
...
const deleteSpecificClient = async (req, res) => {
    ...
    try {
        ...
        return res.status(500).json({ status: 500, message: "An error occurred while deleting the customer." });
    }
};
...
const fetchClientInfoSpecificID = async (req, res) => {
    ...
    try {
        ...
        return res.status(500).json({ status: 500, message: "An error occurred while fetching the specific client" });
    }
};
